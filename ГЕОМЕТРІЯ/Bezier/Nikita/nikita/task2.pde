...
void draw_point(int x,int y){
  switch(cnt){
   ...
   pressY_2=y;
   point(x,y);
   line(pressX_1,pressY_1,pressX_2,pressY_2);
   cnt++;
   break;
   ...
   pressY_3=y;
   point(x,y);
   line(pressX_2,pressY_2,pressX_3,pressY_3);
   cnt++;
   break;
   ...
   pressY_4=y;
   point(x,y);
   line(pressX_3,pressY_3,pressX_4,pressY_4);
   cnt++;
   draw_bez();
   pressX_1=pressX_4;
   pressY_1=pressY_4;
   cnt=1;
   func(pressX_3,pressY_3,pressX_4,pressY_4,50);
   draw_point(sym_x,sym_y);
   break;
  }
}
